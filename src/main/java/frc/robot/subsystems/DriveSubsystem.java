...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    leftLeader = new SparkMax(DriveConstants.kLeftLeaderCANId, MotorType.kBrushless);
    leftFollower = new SparkMax(DriveConstants.kLeftFollowerCANId, MotorType.kBrushless);
    rightLeader = new SparkMax(DriveConstants.kRightLeaderCANId, MotorType.kBrushless);
    rightFollower = new SparkMax(DriveConstants.kRightFollowerCANId, MotorType.kBrushless);
